...
```{r}
outliersLocales=ggplot_build(boxplot)$data[[1]]$outliers[[1]]
outliersLocales
```


Nota que cuandio hay outliers, se puede calcular del grafico los maximos y minimos teóricos:
...
Otro caso importante es cuando analizamos nuestra variable versus una variable categórica. Por ejemplo, saber si se distribuye igual según una región sea más rural que urbana. Traigamos los datos de población:
